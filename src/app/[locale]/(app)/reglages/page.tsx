...
import { getMesConnexions, getMesSessions } from "@/features/compte/data/sessions";
...
export default async function ReglagesPage() {
  ...
  const [profil, sessions, connexions] = await Promise.all([
    getMonProfil(), getMesSessions(), getMesConnexions(),
  ]);
