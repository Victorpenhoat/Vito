...
describe("appIdValide", () => {
  it("accepte un préfixe d'équipe suivi du bundle ID", () => {
    expect(appIdValide("Q7UGNF4Q22.com.exemple.vito")).toBe(true);
  });
  ...
  it("refuse ce qui n'a pas la forme attendue", () => {
    for (const v of [
      "",                              // vide
      "com.exemple.vito",              // bundle sans préfixe
      "Q7UGNF4Q22.vito",               // bundle sans point : pas un reverse-DNS
      "q7ugnf4q22.com.exemple.vito",   // préfixe en minuscules
      "Q7UGNF4Q2.com.exemple.vito",    // 9 caractères
      "Q7UGNF4Q222.com.exemple.vito",  // 11 caractères
      "Q7UGNF4Q22 .com.exemple.vito",  // espace
    ]) {
