...
const FAB_CLASS =
  "fixed bottom-20 right-6 z-20 grid h-14 w-14 place-items-center rounded-full bg-accent text-on-fill shadow-lg shadow-black/30 transition-colors hover:bg-accent-hover md:bottom-6";
