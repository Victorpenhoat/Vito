  ...
  return (
    <>
      <button type="button" data-testid="ajouter-vin" onClick={() => setOpen(true)}
        className="inline-flex shrink-0 items-center gap-1.5 self-start rounded-control border border-accent/25 bg-surface px-3.5 py-2.5 text-xs font-semibold text-accent focus-visible:outline-2 focus-visible:outline-accent">
